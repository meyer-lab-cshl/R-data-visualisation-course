...
automatically choose the axis limits and more importantly here, their ratios. 
...
#### 4.4.2 Labels
Currently, our the axis and legend labels in our plot are simply the name of
the variables we mapped to the aesthetics. We can change the axis labels and add
a plot by providing arguments to the `labs` layer. Specifically, x and y axis
...
3. Test different themes and see how it effects to plot, for instance use
